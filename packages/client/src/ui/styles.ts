...
export const UI_CSS = [
	...
	'.vc-bar-xp .vc-bar-fill { background: #5bbf3a; }',
	'.vc-mp { position: absolute; right: 16px; top: 16px; display: flex; align-items: center;',
	'  gap: 10px; pointer-events: auto; }',
	'.vc-mp-status { font-size: 12px; opacity: 0.85; }',
	'.vc-enchant-list { list-style: none; margin: 0; padding: 0; display: flex;',
	'  flex-direction: column; gap: 6px; min-width: 360px; }',
	'.vc-enchant-row { display: flex; align-items: center; gap: 10px; padding: 8px 10px;',
	'  background: #161b23; border: 1px solid #2c3441; }',
	'.vc-enchant-name { flex: 1; }',
	'.vc-enchant-cost { opacity: 0.75; font-size: 11px; }',
	'.vc-enchant-meta { opacity: 0.8; font-size: 12px; }',
	'.vc-button[disabled] { opacity: 0.45; cursor: not-allowed; }',
