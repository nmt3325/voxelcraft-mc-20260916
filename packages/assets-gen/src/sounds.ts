...
export const SOUND_SPECS: Readonly<Record<string, SoundSpec>> = {
	...
	/* v2: nether travel, enchanting, harvesting and particle pops. */
	portal_travel: [0.9, 0.22, 0.03, 420, 30, 72, 0.5, 0.7, 0.9],
	enchant: [0.55, 0.92, 0.36, 210, 4, 1180, 0.58, 0.4, 0.84],
	crop_harvest: [0.16, 0.88, 0.42, 26, 1, 260, 0.2, -0.3, 0.7],
	particle_pop: [0.05, 0.6, 0.12, 8, 1, 760, 0.72, 0.85, 0.64],
	particle_pop_soft: [0.07, 0.42, 0.06, 12, 1, 420, 0.6, 0.7, 0.56],
}
